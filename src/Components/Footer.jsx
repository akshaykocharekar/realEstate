...
const Footer = () => {
  return (
    <footer className="bg-[#1b1b1b] text-[#f1d9a7] px-6 pt-10 text-center">
      {/* Social Icons */}
      ...
      {/* Description */}
      <p className="max-w-2xl mx-auto text-sm text-[#d6c098] leading-relaxed mb-6">
      ...
      <p className="text-sm text-[#c4af87] mb-6">Goa, India | ₹</p>

      {/* Footer Links */}
      <div className="flex justify-center gap-8 mb-8 text-sm text-[#e6cfa3] flex-wrap">
      ...
      {/* Divider */}
      <div className="border-t border-[#f1d9a7] w-full mb-6"></div>

      {/* Address Row */}
      <div className="flex justify-center mb-4 text-sm text-[#e6cfa3] flex-wrap px-4">
        <p className="mx-2 font-medium">🏢 GoldenKey Realty HQ</p>
      ...
      {/*<div className="w-full h-[250px] mt-0">
        <iframe
